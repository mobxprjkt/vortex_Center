...
package mobx.projects.property;
...
import mobx.projects.property.fragments.team.TeamActivity;
import mobx.projects.property.tabs.Hardware;
import mobx.projects.property.tabs.Lockscreen;
import mobx.projects.property.tabs.Statusbar;
import mobx.projects.property.tabs.System;

import mobx.projects.property.navigation.BubbleNavigationConstraintView;
import mobx.projects.property.navigation.BubbleNavigationChangeListener;

public class Vortex extends SettingsPreferenceFragment {
...
//    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.mobx_expandable_top_bar, container, false);

        ActionBar actionBar = getActivity().getActionBar();
        if (actionBar != null) {
            actionBar.setTitle(R.string.vortex_title);
        }
