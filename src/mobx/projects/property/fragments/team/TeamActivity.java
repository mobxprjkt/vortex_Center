...
package mobx.projects.property.fragments.team;
...
public class TeamActivity extends Activity {
    ...
    private void initTeam(){
       ...
       setTeamMember("Unknown", getString(R.string.leaddeveloper_title), "unknown", "unknown",
                R.drawable.me);
        setTeamMember("Unknown", getString(R.string.developer_title), "unknown", "unknown",
                R.drawable.me);
       setTeamMember("Unknown", getString(R.string.developer_title), "unknown", "unknown",
                R.drawable.me);
       setTeamMember("Unknown", getString(R.string.graphicsdesigner_title), "unknown", "unknown",
                R.drawable.me);
