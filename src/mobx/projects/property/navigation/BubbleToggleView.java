package mobx.projects.property.navigation;
...
import mobx.projects.property.navigation.ViewUtils;
        ...
        if (attrs != null) {
            ...
            try {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
                    icon = ta.getDrawable(R.styleable.BubbleToggleView_vortex_icon);
                else
                icon = AppCompatResources.getDrawable(getContext(), ta.getResourceId(R.styleable.BubbleToggleView_vortex_icon, R.drawable.default_icon));
                iconWidth = ta.getDimension(R.styleable.BubbleToggleView_vortex_iconWidth, iconWidth);
                iconHeight = ta.getDimension(R.styleable.BubbleToggleView_vortex_iconHeight, iconHeight);
                shape = ta.getDrawable(R.styleable.BubbleToggleView_vortex_shape);
                shapeColor = ta.getColor(R.styleable.BubbleToggleView_vortex_shapeColor, shapeColor);
                showShapeAlways = ta.getBoolean(R.styleable.BubbleToggleView_vortex_showShapeAlways, false);
                title = ta.getString(R.styleable.BubbleToggleView_vortex_title);
                titleSize = ta.getDimension(R.styleable.BubbleToggleView_vortex_titleSize, titleSize);
                colorActive = ta.getColor(R.styleable.BubbleToggleView_vortex_colorActive, colorActive);
                colorInactive = ta.getColor(R.styleable.BubbleToggleView_vortex_colorInactive, colorInactive);
                isActive = ta.getBoolean(R.styleable.BubbleToggleView_vortex_active, false);
                animationDuration = ta.getInteger(R.styleable.BubbleToggleView_vortex_duration, DEFAULT_ANIM_DURATION);
                internalPadding = (int) ta.getDimension(R.styleable.BubbleToggleView_vortex_padding, internalPadding);
                titlePadding = (int) ta.getDimension(R.styleable.BubbleToggleView_vortex_titlePadding, titlePadding);
            } finally {
                ta.recycle();
            }
        }
